...
def main():
    ...
    parser.add_argument(
        "--config", type=str, default=None, help="Path to YAML config file (recommended)"
    )
    ...
    parser.add_argument("--crossover-prob", type=float, default=0.7, help="Crossover probability")
    ...
    parser.add_argument("--elitism-ratio", type=float, default=0.1, help="Elitism ratio")
    ...
    # Fitness args
    parser.add_argument(
        "--accuracy-weight", type=float, default=0.7, help="Weight for accuracy in fitness"
    )
    parser.add_argument(
    ...
    # Output args
    parser.add_argument(
        "--output", type=str, default="models/best_tree.pkl", help="Output file for best model"
    )
    ...
    print(
        f"Configuration: pop={args.population}, gen={args.generations}, " f"depth={args.max_depth}"
    )
    if args.config:
